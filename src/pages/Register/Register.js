...
function Register() {
  ...
  //       } else {
  //         console.log("Invalid response received from the API");
  //       }
  //     })
  //     .catch((err) => {
  ...
  // const userData = {
  //   taiKhoan: "hhoang1072003@gmail.com",
  //   matKhau: "hoangdtr123",
  //   email: "hhoang1072003@gmail.com",
  //   soDt: "07888400008",
  //   maNhom: "01",
  //   hoTen: "Huy Hoang Huynh",
  // };
  useEffect(() => {
  ...
  const handleRegister = () => {
    if (userName && userPassword && userEmail && userSdt && userAccount) {
      const user = {
        userName: userName,
      ...
      alert("đăng kí tải khoản thành công");
      // window.history.back();
    } else {
      setRegister(true);
    }
        ...
        <>
          <div className="bg">
            <div className="register">
              <div className="pt-5 px-8 pb-7 text-white">
                ...
                >
                  ...
                  <div className="mb-4 mt-4">
                    ...
                    <input
                      ...
                      value={userSdt}
                      onChange={(e) => {
                        setUserSdt(e.target.value);
                      }}
                    />
                  </div>
                  <div className="text-center p-2">
                    <button
                      className="buttonDk hover:bg-green-700"
                      type="button"
                  ...
                  {register && (
                    <Space direction="vertical" className="alert-rg">
                      <Alert
              ...
              <Link to="/">
                <button className="btnclose hover:opacity-70">
