...
function Login() {
  ...
  const handleLogin = () => {
    ...
    if (useraccount === user.userAccount && password === user.userPassword) {
      const userLogin = {
        isLogin: true,
    ...
    <div className="bg">
      <div className="login">
        <div className="pt-5 px-8 pb-7 text-white">
          ...
          <form action="#" className="max-w-full relative w-full mr-3 ml-3">
            <div className="mb-4 mt-4 ml-16">
            ...
            <span className="text-green-500 ml-16 my-4 cursor-pointer">
              * Đăng ký
            </span>
            <div className="text-center p-2">
              <button className="buttonDN" type="button" onClick={handleLogin}>
                Đăng Nhập
              </button>
            </div>
          </form>
